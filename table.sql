...
DROP TABLE IF EXIST GLPI_INVENTORY CASCADE CONSTRAINTS;
DROP TABLE IF EXIST LIST_INVENTORY_ITEM CASCADE CONSTRAINTS;
DROP TABLE IF EXIST GLPI_USER CASCADE CONSTRAINTS;
DROP TABLE IF EXIST GLPI_TICKET CASCADE CONSTRAINTS;
DROP TABLE IF EXIST GLPI_TICKET_TASK CASCADE CONSTRAINTS;
DROP TABLE IF EXIST GLPI_TICKET_SOLUTION CASCADE CONSTRAINTS;
DROP TABLE IF EXIST LIST_TICKET_TASK CASCADE CONSTRAINTS;
DROP TABLE IF EXIST LIST_TICKET_SOLUTION CASCADE CONSTRAINTS;
DROP TABLE IF EXIST GLPI_NOTIFICATION CASCADE CONSTRAINTS;
